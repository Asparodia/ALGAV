...
plt.plot([100, 200, 500, 1000,5000,10000,20000,50000], [0.0, 3.12, 3.12,6.25 ,56.25 ,137.52,275.25,675.08],label= "File Binomiale",color="blue")
plt.plot([100, 200, 500, 1000,5000,10000,20000,50000], [0.0, 3.12, 3.12,6.25 ,56.25 ,137.52,275.25,675.08],'x',color="b")
